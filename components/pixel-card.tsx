...
export default function PixelCard({
  ...
  style,
  children,
}: Readonly<PixelCardProps>): JSX.Element {
  ...
  const initPixels = () => {
    ...
    for (let x = 0; x < width; x += parseInt(finalGap.toString(), 10)) {
      for (let y = 0; y < height; y += parseInt(finalGap.toString(), 10)) {
        // Skip ~40% of pixels randomly to create sparse, missing-pixel effect
  ...
  return (
    ...
    >
      ...
      <canvas
        className="absolute inset-0 w-full h-full block pointer-events-none opacity-60"
        ref={canvasRef}
      />
